...
const learningGoalsData = {
  ...
  "Curie Study Group": [
    ...
    },
    {
      ...
      description: "Learn from curated experience creating technical content",
    },
  ],
  "Darwin Data Science Guild": [
    {
...
const freeUserAssignments = {
  Ada: {
    community: "Ada Full Stack Lab",
    goal: "Next.js App Router & Server Components",
  },
  Babbage: {
    community: "Curie Study Group",
  ...
  Darwin: {
    community: "Babbage Leadership Circle",
    goal: "Technical leadership skills",
  },
  Euler: {
    community: "Euler AI & Machine Learning",
...
const proUserGoalAssignments = {
  ...
  "Newton Pro": {
    ...
    "Darwin Data Science Guild": ["Pandas data manipulation"],
  },
  "Turing Pro": {
    "Ada Full Stack Lab": [
      "Next.js App Router & Server Components",
    ...
    "Babbage Leadership Circle": ["Technical leadership skills"],
  },
};
...
async function comprehensiveSeed() {
  ...
  try {
    ...
    const matchPairs = [
      ...
      ["Feynman Pro", "Maxwell Pro", "Euler AI & Machine Learning"],
      ["Gauss Pro", "Lovelace Pro", "Feynman Cloud & DevOps"],
      ["Curie Pro", "Feynman Pro", "Euler AI & Machine Learning"],
      ["Darwin Pro", "Gauss Pro", "Feynman Cloud & DevOps"],
      ["Turing Pro", "Euler Pro", "Babbage Leadership Circle"],
      ["Newton Pro", "Lovelace Pro", "Feynman Cloud & DevOps"],

      // FREE to PRO matches (showing FREE users can match within limits)
      ["Ada", "Curie Pro", "Ada Full Stack Lab"],
      ["Babbage", "Feynman Pro", "Darwin Data Science Guild"],
      ["Darwin", "Darwin Pro", "Babbage Leadership Circle"],
    ];
    ...
    console.log("\n💡 YOUR ACCOUNTS (PRO):");
    console.log("   • jdalk;jfl;as@gmail.com");
    console.log("   • fasdfas.adfsafas09@gmail.com");
    console.log("\n💡 OTHER TEST ACCOUNTS:");
    console.log("   • free1@email.com (FREE)");
    console.log("   • test@gmail.com (PRO)\n");
    console.log("🏘️  COMMUNITIES:");
    console.log("   • Ada Full Stack Lab");
    console.log("   • Babbage Leadership Circle");
    console.log("   • Curie Study Group");
    console.log("   • Darwin Data Science Guild");
    console.log("   • Euler AI & Machine Learning");
    console.log("   • Feynman Cloud & DevOps\n");
  } catch (error) {
